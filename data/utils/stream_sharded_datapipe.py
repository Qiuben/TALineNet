...
class ShardedStreamingDataPipe(IterDataPipe):
    ...
    def assign_datapipes_to_worker(cls,
        ...
        # print(colored(f"num_datapipes: {num_datapipes}", "red"))
        # print(colored(f"total_num_workers: {total_num_workers}", "green"))
        # print(colored(f"global_worker_id: {global_worker_id}", "blue"))
